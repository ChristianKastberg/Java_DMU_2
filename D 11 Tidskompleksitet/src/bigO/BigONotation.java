...
public class BigONotation {
	...
	public static void main(String[] args) {
		...
		BigONotation testAlgo6 = new BigONotation(1000);
		testAlgo6.generateRandomArray();

		BigONotation testAlgo7 = new BigONotation(10000);
...
//		 0(log N) Test
		...
		System.out.println("Quick Sort Took MilliSeconds " + (endTime - startTime));
	...
	public void linearSearchForValue(int value) {
		...
		System.out.println("Linear Search Took MilliSeconds " + (endTime - startTime));
	...
	public void bubbleSort() {
		...
		System.out.println("Bubble Sort Took MilliSeconds " + (endTime - startTime));
	}
	...
	public void binarySearchForValue(int value) {
		...
		System.out.println("Binary Search Took MilliSeconds " + (endTime - startTime));
